 ...
 *
 */
public class EditAssetViewBAK extends AbstractMasterView implements ISelectionListener, ISelectionChangedListener
{
...
/**
	...
	public void setStock(Stock incomingStock) 
	{
	this.stock = incomingStock;
	...
	/**
	 * <p>Der ISelectionListener wird benachrichtigt, wenn der IndexTreeView ausgewählt wird.
	 ...
	 * </p>
	 * <p>
	 * Erstellt eine neue update value strategy mit einer konfigurierbaren Update-Strategie.
	 * Standard Validatoren und ein Standard Konverter werden bereitgestellt, wenn
	 * <code>provideDefaults</code> <code>true</code> ist. Die Standards können geändert 
	 * werden, indem die setter Methoden aufgerufen werden. Folgende Setter stehen zur Verfügung:
	 * <ul>
	 * <li>
	 * setAfter<b>Get</b>Validator: Der Validator wird aufgerufen, nachdem der Quellwert
	 * abgerufen wurde am Anfang des Synchronisationsprozesses
	 * </li>
	 * <li>
	 * setAfter<b>Convert</b>Validator: Der Validator wird aufgerufen, nachdem der Quellwert in den Typ
	 * des Zielwertes konvertiert wurde.
	 * </li>
	 * <li>
	 * set<b>BeforeSet</b>Validator: Der Validator wird aufgerufen, bevor der Zielwert
	 * gesetzt wird, am Ende des Synchronisationsprozesses
	 * </li>
	 * <li>
	 * set<b>Converter</b>: Ein Konverter wird aufgerufen, während der Quellwert in den Zielwert
	 * konvertiert wird.
	 * </li>
	 * </ul>
	 * 
	 * @param provideDefaults
	 * Wenn <code>true</code>, wird ein Standard Validator und ein Standard Konverter
	 * entsprechend des Typs der Zielwertes bereitgestellt.
	 * 
	 * @param updatePolicy
	 * Eine der folgenden Update-Strategien:
	 * <ul>
	 * <li>
	 * POLICY_NEVER: der Status des Quellwertes wird nicht verfolgt und der Zielwert wird nicht aktualisiert 
	 * </li>
	 * <li>
	 * POLICY_ON_REQUEST: der Status des Quellwertes wird nicht verfolgt, aber der Zielwert wird validiert, 
	 * konvertiert und aktualisiert falls es angefordert wird. 
	 * </li>
	 * <li>
	 * POLICY_CONVERT: der Status des Quellwertes wird verfolgt und validiert ausser für validateBeforeSet.
	 * Der Zielwert wird nur auf Anfrage aktualisiert. 
	 * </li>
	 * <li>
	 * POLICY_UPDATE: der Status des Quellwertes wird verfolgt, validiert und konvertiert. Der Zielwert wird bei 
	...
	public void selectionChanged(IWorkbenchPart sourcepart, ISelection selection) 
	{
		...
		IObservableValue observableSelection = ViewersObservables.observeSingleSelection(indexTreeView.getTreeViewer());
		
		UpdateValueStrategy updateValueStrategy = new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER);
		...
		// isin
		IObservableValue isinObservable = 	BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"isin", 
											String.class);
		bindingContext.bindValue(			SWTObservables.observeText(isin, SWT.Modify), 
											isinObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);
		// wkn
		IObservableValue wknObservable = 	BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"wkn", 
											String.class);
		bindingContext.bindValue(			SWTObservables.observeText(wkn, SWT.Modify), 
											wknObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);
		
		// type
		IObservableValue typeObservable = 	BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"type", 
											String.class);
		bindingContext.bindValue(			ViewersObservables.observeSingleSelection(assetType), 
											typeObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);		
		...
		IObservableValue symbolObservable = BeansObservables.observeDetailValue(Realm.getDefault(), 
											...
											"symbol", 
											String.class);
		bindingContext.bindValue(			SWTObservables.observeText(symbol, SWT.Modify), 
											symbolObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);			
		// ibSymbol
		IObservableValue ibSymbolObservable = BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"ibSymbol", 
											String.class);						
		bindingContext.bindValue(			SWTObservables.observeText(ibSymbol, SWT.Modify), 
											ibSymbolObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);	
		
		IObservableValue quantumObservable = BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"stockQuantum", 
											Long.class);						
		//stockQuantum
		bindingContext.bindValue(			SWTObservables.observeText(stockQuantum, SWT.Modify), 
											quantumObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);	

		// currency
		IObservableValue currencyObservable = BeansObservables.observeDetailValue(Realm.getDefault(), 
											observableSelection,
											"currency", 
											String.class);
		bindingContext.bindValue(			ViewersObservables.observeSingleSelection(currency), 
											currencyObservable,
											new UpdateValueStrategy(false, UpdateValueStrategy.POLICY_NEVER), 
											null);				
